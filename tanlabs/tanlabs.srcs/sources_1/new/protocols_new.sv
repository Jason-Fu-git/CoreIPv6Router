...
// =============================================================
	...
	assign ns_valid = (
		...
		&& (ns_checksum_ok)
		&& (ns_na_packet_i.ether.ip6.src == ns_packet_i.icmpv6.target_addr)
	);
	...
	always_comb begin
		...
		ns_na_packet_i.ether.ip6.payload_len = {8'd32, 8'd0}            ;  // 24 bytes for ICMPv6 header, 8 bytes for option
